...
import Contact from "@/components/section/contact_donation";
                                            ...
                                            <div className="accordion-item">
                                              ...
                                              >
                                                ...
                                                >
                                                  ...
                                                  <span className="text-white">
                                                  <i className={`icofont-square-${openSection === 'scholarships' ? 'up' : 'down'}`}></i>
                                              ...
                                              <div
                                                id="videolist1"
                                                className={`accordion-collapse collapse${openSection === 'scholarships' ? ' show' : ''}`}
                                            ...
                                            <div className="accordion-item">
                                              ...
                                              >
                                                ...
                                                >
                                                  ...
                                                  <span className="text-white">
                                                  <i className={`icofont-square-${openSection === 'gold' ? 'up' : 'down'}`}></i>
                                                  </span>{" "}
                                                </button>
                                              </div>
                                              <div
                                                id="videolist2"
                                                className={`accordion-collapse collapse${openSection === 'gold' ? ' show' : ''}`}
                                            ...
                                            <div className="accordion-item">
                                              ...
                                              >
                                                ...
                                                >
                                                  ...
                                                  <span className="text-white">
                                                  <i className={`icofont-square-${openSection === 'books' ? 'up' : 'down'}`}></i>
                                                  </span>{" "}
                                                </button>
                                              </div>
                                              <div
                                                id="videolist3"
                                                className={`accordion-collapse collapse${openSection === 'books' ? ' show' : ''}`}
                                            ...
                                            <div className="accordion-item">
                                              ...
                                              >
                                                ...
                                                >
                                                  ...
                                                  <span className="text-white">
                                                  <i className={`icofont-square-${openSection === 'research' ? 'up' : 'down'}`}></i>
                                                  </span>{" "}
                                                </button>
                                              </div>
                                              <div
                                                id="videolist4"
                                                className={`accordion-collapse collapse${openSection === 'research' ? ' show' : ''}`}
                                            ...
                                            <div className="accordion-item">
                                              ...
                                              >
                                                <button
                                                  ...
                                                  onClick={()=>toggleSection('endowment')}
                                                >
                                                  {" "}
                                                  <span className="text-white">
                                                    ENDOWMENT CHAIR
                                                  ...
                                                  <span className="text-white">
                                                  <i className={`icofont-square-${openSection === 'endowment' ? 'up' : 'down'}`}></i>
                                                  </span>{" "}
                                                </button>
                                              </div>
                                              <div
                                                id="videolist5"
                                                className={`accordion-collapse collapse${openSection === 'endowment' ? ' show' : ''}`}
                                            ...
                                            <div className="accordion-item">
                                              ...
                                              >
                                                ...
                                                >
                                                  ...
                                                  <span className="text-white">
                                                  <i className={`icofont-square-${openSection === 'infrastucture' ? 'up' : 'down'}`}></i>
                                                  </span>{" "}
                                                </button>
                                              </div>
                                              <div
                                                id="videolist6"
                                                className={`accordion-collapse collapse${openSection === 'infrastructure' ? ' show' : ''}`}
                                            ...
                                            <div className="accordion-item">
                                              ...
                                              >
                                                ...
                                                >
                                                  ...
                                                  <span className="text-white">
                                                  <i className={`icofont-square-${openSection === 'expertise' ? 'up' : 'down'}`}></i>
                                                  </span>{" "}
                                                </button>
                                              </div>
                                              <div
                                                id="videolist7"
                                                className={`accordion-collapse collapse${openSection === 'expertise' ? ' show' : ''}`}
