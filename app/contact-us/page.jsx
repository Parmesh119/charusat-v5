                      ...
                      <div className="accordion-item">
                        <div className="accordion-header" id="accordion02">
                          ...
                          >
                            ...
                            <i className={`icofont-square-${openSection === 'sports' ? 'up' : 'down'}`}></i>
                          </button>
                        </div>
                        <div
                          id="videolist2"
                          className={`accordion-collapse collapse${openSection === 'sports' ? ' show' : ''}`}
                      ...
                      <div className="accordion-item">
                        <div className="accordion-header" id="accordion03">
                          ...
                          >
                            ...
                            <i className={`icofont-square-${openSection === 'Examination' ? 'up' : 'down'}`}></i>
                          </button>
                        </div>
                        <div
                          id="videolist3"
                          className={`accordion-collapse collapse${openSection === 'Examination' ? ' show' : ''}`}
                      ...
                      <div className="accordion-item">
                        <div className="accordion-header" id="accordion04">
                          ...
                          >
                            ...
                            <i className={`icofont-square-${openSection === 'HR' ? 'up' : 'down'}`}></i>
                          </button>
                        </div>
                        <div
                          id="videolist4"
                          className={`accordion-collapse collapse${openSection === 'HR' ? ' show' : ''}`}
                      ...
                      <div className="accordion-item">
                        <div className="accordion-header" id="accordion05">
                          ...
                          >
                            ...
                            <i className={`icofont-square-${openSection === 'Accounts' ? 'up' : 'down'}`}></i>
                          </button>
                        </div>
                        <div
                          id="videolist5"
                          className={`accordion-collapse collapse${openSection === 'Accounts' ? ' show' : ''}`}
                      ...
                      <div className="accordion-item">
                        <div className="accordion-header" id="accordion01">
                          ...
                          >
                            ...
                            <i className={`icofont-square-${openSection === 'Lodge' ? 'up' : 'down'}`}></i>
                          </button>
                        </div>
                        <div
                          id="videolist1"
                          className={`accordion-collapse collapse${openSection === 'Lodge' ? ' show' : ''}`}
